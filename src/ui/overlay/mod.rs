...
use crate::app::{
    ...
    App, ArchiveForm, AutoBackupField, AutoBackupForm, AutoBackupFormMode, Availability, Category,
    DashboardForm, DashboardFormMode, DiskCreateForm, DiskField, DiskServerPicker, DiskSourceKind,
    DnsRecordForm, DnsRecordFormMode, DnsZoneForm, DnsZoneFormMode, IamCredentialForm,
    IamResourceForm, IamResourceFormMode, IamRoleForm, LogMeasureRuleForm, LogMeasureRuleFormMode,
    LogRoutingForm, LogRoutingFormMode, LoginForm, MetricsRoutingForm, MetricsRoutingFormMode,
    NicChoice, NicPicker, NotificationRoutingForm, NotificationRoutingFormMode,
...
pub fn draw(frame: &mut Frame, app: &App) {
    ...
    match overlay {
        ...
        Overlay::AutoBackupForm(form) => draw_auto_backup_form(frame, form, app),
